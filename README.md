...
```bash
"kitsunecode/router": "1.0.*"
```

or run

```bash
composer require kitsunecode/router
```
...
<form action="" method="POST">
    ...
    <input type="text" name="first_name" value="Enos"/>
    <input type="text" name="last_name" value="Santana"/>
    <input type="text" name="email" value="devenos@icloud.com"/>
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://localhost/kitsunecode/router/exemple/spoofing/",
  ...
  CURLOPT_POSTFIELDS => "first_name=Enos&last_name=Santana&email=devenos%40icloud.com",
...
The MIT License (MIT). Please see [License File](https://github.com/enosfox/router/blob/master/LICENSE) for more information.